...
All numbers used in a FLAC bitstream MUST be integers; there are no floating-point representations. All numbers MUST be big-endian coded. All numbers SHOULD be unsigned unless otherwise specified.
